#include "utils/cxxconfig.h"
#include "utils/datetime.h"

#if defined(BPM_WINDOWS)
	#include <windows.h>
#endif
...
namespace {
	std::tm localtime()
	{
#if defined(BPM_WINDOWS) && !defined(BPM_MINGW)
		time_t t;
		::time(&t);
		std::tm tm;
