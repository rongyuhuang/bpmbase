...
void InitLogging(const wchar_t* log_file,
...
#define COMPACT_GOOGLE_LOG_INFO logging::LogMessage(__FILE__, __LINE__)
...
#define DCHECK_OP(name, op, val1, val2)                                                                       \
    if (logging::CheckOpString _result = logging::Check##name##Impl((val1), (val2), #val1 " " #op " " #val2)) \
...
#define DCHECK_STROP(func, op, expected, s1, s2)                                                          \
    while (CheckOpString _result = logging::Check##func##expected##Impl((s1), (s2), #s1 " " #op " " #s2)) \
...
#define DCHECK(condition) \
    !logging::g_enable_dcheck ? void(0) : LOG_IF(FATAL, !(condition)) << "Check failed: " #condition ". "
