...
// reference for handling inputs.
// Commented out to avoid dragging dependencies on <windows.h> types. You can
// copy the extern declaration in your code.
/*
IMGUI_API LRESULT   ImGui_ImplDX9_WndProcHandler(HWND hWnd, UINT msg, WPARAM
